    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h2 class="text-center mb-4"> Create Teachers </h2>
                <a href="{{ route('Teachers.index') }}" class="btn btn-success">Back Home</a>

                <form class="mb-5" action="{{ route('Teachers.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="degree" placeholder="Enter the Degree">
                        @error("degree")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
